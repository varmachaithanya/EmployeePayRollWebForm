<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ULogin.aspx.cs" Inherits="EmployeePayRoleForm.ULogin" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="Button1" runat="server" OnClick="Button_Login" Text="Login" BackColor="#0066FF" ForeColor="White" />
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
